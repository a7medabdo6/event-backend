...
let UsersService = class UsersService {
    ...
    async create(UpdateUser) {
        ...
        if (!user) {
            throw new common_1.NotFoundException('user not found please call admin for more info');
        }
    ...
    createCodeadmin(CreateCodeDto) {
        const user = this.repo.create(Object.assign(Object.assign({}, CreateCodeDto), { type: "admin", role: "admin" }));
        return this.repo.save(user);
    }
